...
?>
			...
			<div class="col-lg-9 col-md-9">
				...
				$pending = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tproblems where status_problem='PENDING' and idprob like 'PGA%';"));
				
				//ESTIMASI WAKTU
				$div = mysqli_fetch_array(mysqli_query($conn, "select *from user where username='$_SESSION[username]'"));
					$ww = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM tassign t where (EST_DAY IS NULL OR EST_HOUR IS NULL OR EST_MIN IS NULL) and NO_PELAPORAN like 'PGA%';"));
									...
									default:
											$prob = "SELECT * FROM tproblems p
												...
												left join user u on u.username = ta.pic_handling
												 WHERE p.idprob like 'PGA%' AND ((p.status_problem NOT IN ('CLOSED') AND ta.created_date IN
														(select max(created_date) from tassign group by no_pelaporan)) OR p.status_problem IN ('OPEN'))";
										...
										case "bulanini" :
											$prob = "SELECT * FROM tproblems p
												...
												and ta.created_date IN
														(select max(created_date) from tassign group by no_pelaporan) and p.idprob like 'PGA%'
												";
												if($_GET[show]=='pribadi'){
													$prob .= " AND p.created_by = '$_SESSION[username]' ";
												}else{}
										...
										case "open" :
											$prob = "SELECT * FROM tproblems p
												...
												left join tassign ta on p.idprob = ta.no_pelaporan
												left join user u on u.username = ta.pic_handling
												where p.status_problem='OPEN' and p.idprob like 'PGA%'
												";
												if($_GET[show]=='pribadi'){
													$prob .= " AND p.created_by = '$_SESSION[username]' ";
												}else{}
										...
										case "assign" :
											$prob = "SELECT * FROM tproblems p
												...
												left join tassign ta on p.idprob = ta.no_pelaporan
												left join user u on u.username = ta.pic_handling
												where p.status_problem='ASSIGN' and p.idprob like 'PGA%'
												and ta.created_date IN
			...
			?>
						...
						<tr><td width='90%'><h2><u>Daftar Laporan Kerusakan</u><font color='red'><b><?php echo $stt; ?></b></font></h2></td>
							<td><a href='<?php echo "?p=dashboard-internal&show=pribadi&act=$_GET[act]";?>' title='Klik untuk melihat laporan milik Anda' class='btn btn-sm btn-success'>Pribadi</a></td>
									...
									<?php
										...
										while ($data = mysqli_fetch_assoc($ptampil))
										{
											...
											if($div[level]=='superadmin'){
												...
												if($data[status_problem]=='APPROVED'){$kirim = "?p=todolist&act=problem-detail&ds=approved&id=$data[idprob]&s=close&tek=$data[PIC_HANDLING]";}
...
?>
				 ...
				 <div class="cardds top_counter">
                        <div class="body">
							...
							<div class="content">
								...
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM tassign t where (EST_DAY IS NULL OR EST_HOUR IS NULL OR EST_MIN IS NULL) and NO_PELAPORAN like 'PGA%';"));
				...
				if($pending > 0 && $div[divisi]=='GA' && $div[level]=='superadmin'){
					?>
			<div class="col-lg-12 col-md-12">
				 <div class="cardds top_counter">
                        <div class="body">
							...
							<div class="content">
								...
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM tproblems where status_problem='PENDING' and idprob like 'PGA%';"));
				...
				<div class="col-lg-12 col-md-12">
				 <div class="cardds top_counter">
                        <div class="body">
							<a href='?p=dashboard-internal&act=open'><div class="icon"><i class="fa fa-hourglass-half"></i> </div></a>
							<div class="content">
								<div class="text"><b>Open</b></div>
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"select *from tproblems p
									where status_problem ='OPEN' and p.idprob like 'PGA%'"));
				...
				<div class="col-lg-12 col-md-12">
					<div class="cardds top_counter">
                        <div class="body">
							<a href='?p=dashboard-internal&act=assign'><div class="icon"><i class="fa fa-signature"></i> </div></a>
							<div class="content">
								<div class="text"><b>Assigned</b></div>
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"select *from tproblems p
									where status_problem ='ASSIGN' and p.idprob like 'PGA%'"));
				...
				<div class="col-lg-12 col-md-12">
					<div class="cardds top_counter">
                        <div class="body">
							<a href='?p=dashboard-internal&act=inprogress'><div class="icon"><i class="fa fa-spinner"></i> </div></a>
							<div class="content">
								<div class="text"><b>In Progress</b></div>
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"select *from tproblems p
									where status_problem ='IN PROGRESS' and p.idprob like 'PGA%'"));
				...
				<div class="col-lg-12 col-md-12">
					<div class="cardds top_counter">
                        <div class="body">
							<a href='?p=dashboard-internal&act=menunggusp' title='Menunggu Sparepart'><div class="icon"><i class="fa fa-cog"></i> </div></a>
							<div class="content">
								<div class="text"><b>Sparepart</b></div>
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"select *from tproblems p
									where status_problem ='MENUNGGU SPAREPART' and p.idprob like 'PGA%'"));
				...
				<div class="col-lg-12 col-md-12">
					<div class="cardds top_counter">
                        <div class="body">
							<a href='?p=dashboard-internal&act=finish'><div class="icon"><i class="fa fa-check"></i> </div></a>
							<div class="content">
								<div class="text"><b>Finish</b></div>
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"select *from tproblems p
									where status_problem ='FINISH' and p.idprob like 'PGA%'"));
				...
				<div class="col-lg-12 col-md-12">
					<div class="cardds top_counter">
                        <div class="body">
							<a href='?p=dashboard-internal&act=approved'><div class="icon"><i class="fa fa-user"></i> </div></a>
							<div class="content">
								<div class="text"><b>Approved</b></div>
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"select *from tproblems p
									where status_problem ='APPROVED' and p.idprob like 'PGA%'"));
				...
				<div class="col-lg-12 col-md-12">
					<div class="cardds top_counter">
                        <div class="body">
							<a href='?p=dashboard-internal&act=rejected'><div class="icon"><i class="fa fa-window-close"></i> </div></a>
							<div class="content">
								<div class="text"><b>Rejected</b></div>
								<h4 class="number">
								<?php
									$p = mysqli_num_rows(mysqli_query($conn,"select *from tproblems p
									where status_problem ='REJECTED' and p.idprob like 'PGA%'"));
