                           ...
                           <?php
							...
							<li>
								...
								<!--	<li><a href="?p=report"><i class="fa fa-user"></i> Report Masalah</a></li> -->
									...
									<li><a href="?p=searchadjustmentout"><i class="fa fa-users"><b>Report Adjustmentout</b></a></li>
								</ul>
							</li>
							<?php
							}
							...
							<li>
								...
								<!--	<li><a href="?p=report"><i class="fa fa-user"></i> Report Masalah</a></li> -->
									...
									<li><a href="?p=report-jadwalmtc"><i class="fa fa-file"></i> Report Jadwal</a></li>
									<li><a href="?p=searchadjustmentout"><i class="fa fa-users"></i>Search Adjustmentout</a></li>
									<li><a href="?p=reportadjustmentout"><i class="fa fa-users"></i>Report Adjustmentout</a></li>
								</ul>
							</li>
							<?php
							}
